...
public class DateUtil {
	 ...
	 * @param date
	 *            日期
	 * @return 和当前日期进行比较大小   <0:小于当前时间的秒数  >0:大于当前时间的秒数
	 */
	public static int getIntervalSecond(Date date) {
		int num = 0;
		Date dateTmp = DateUtil.StringToDate(DateUtil.getDate(date),
	 ...
	 * @param date
	 *            日期
	 * @return 和当前日期进行比较大小   <0:小于当前时间的天数  >0:大于当前时间的天数
	 */
	...
	public static String getAge(Date birthday) {
		int dis = DateUtil.getIntervalDays(new Date(), birthday);
		int year = dis / 365;

...
import com.test.wechat.resp.BaiduPlace;
...
public class BaiduMapUtil {  
    ...
    public static List<BaiduPlace> searchPlace(String query, String lng, String lat) throws Exception {
        // 拼装请求地址  
        String requestUrl = "http://api.map.baidu.com/place/v2/search?&query=QUERY&location=LAT,LNG&radius=2000&output=xml&scope=2&page_size=10&page_num=0&ak=ftzHC9uZaAjVeXoP1ynx0rrVGdUgkdt4";  
...
//        String basePath = "http://1.wxquan.sinaapp.com/";  
        String basePath = "http://19063839.nat123.net/wxquan/";  
    ...
    public static UserLocation convertCoord(String lng, String lat) {
        ...
        try {  
            ...
            // 对转换后的坐标进行Base64解码  
            location.setLocationBdX(URLDecoder.decode(jsonObject.getString("x"), "UTF-8"));
            location.setLocationBdY(URLDecoder.decode(jsonObject.getString("y"), "UTF-8"));
        } catch (Exception e) {  
            location = null;  
            e.printStackTrace();  
        }  
